...
class OpenAIVisionClient:
    ...
    # Updated method with the new system prompt
    def ask_text_only(self, prompt, context=""):
        """Ask a text-only question with enhanced formatting"""
        try:
            messages = [
    ...
    def ask_with_image(self, prompt, image_path, context=""):
        """Ask a question with both text prompt and image with enhanced formatting"""
        try:
            # Encode the image
